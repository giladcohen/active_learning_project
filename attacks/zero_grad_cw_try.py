...
class ZeroGrad(EvasionAttack):
    ...
    def __init__(
        ...
        """
        Create a Zero Grad L_2 attack instance.
        ...
        """
        super(ZeroGrad, self).__init__(estimator=classifier)
    ...
    def generate(self, x: np.ndarray, y: Optional[np.ndarray] = None, **kwargs) -> np.ndarray:
        ...
        :param y: Target values (class labels) one-hot-encoded of shape (nb_samples, nb_classes) or indices of shape
                  ...
                  labels.
                  In our implementation y = None always because it is untargeted.
        ...
        for batch_id in trange(nb_batches, desc="ZeroGrad"):
            ...
            for bss in range(self.binary_search_steps):
                ...
                for i_iter in range(self.max_iter):
                    ...
                    logger.debug("Average Zero Grad Loss: %f", np.mean(loss - l2dist))
                    logger.debug(
                    ...
                    for i_halve in range(self.max_halving):
                        ...
                        l2dist[active_and_do_halving], loss[active_and_do_halving] = self._loss(
                        ...
                        logger.debug("New Average Zero Grad Loss: %f", np.mean(loss - l2dist))
                    ...
                    for i_double in range(self.max_doubling):
                        ...
                        new_x_adv_batch = tanh_to_original(new_x_adv_batch_tanh, clip_min, clip_max)
                        l2dist[active_and_do_doubling], loss[active_and_do_doubling] = self._loss(
        ...
        logger.info(
            "Success rate of Zero Grad attack: %.2f%%",
            100 * compute_success(self.estimator, x, y, x_adv, False, batch_size=self.batch_size),
        )
