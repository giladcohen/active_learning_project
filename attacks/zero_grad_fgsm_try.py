...
class ZeroGrad(EvasionAttack):
    ...
    def __init__(
        ...
        """
        super(ZeroGrad, self).__init__(estimator=estimator)
        self.norm = norm
        self.eps = eps
    ...
    def generate(self, x: np.ndarray, y: Optional[np.ndarray] = None, **kwargs) -> np.ndarray:
        ...
        :param y: Target values (class labels) one-hot-encoded of shape (nb_samples, nb_classes) or indices of shape
                  ...
                  Here we use only untargeted attack, so y = None.
        ...
        logger.info("Using model predictions as correct labels for ZeroGrad.")
        ...
        if self.minimal:
            logger.info("Performing minimal perturbation ZeroGrad.")
